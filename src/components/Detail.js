...
function Detail() {
  return (
    <Container>
        <Background>
            <img src="https://4.bp.blogspot.com/-KuWXfA_2zEw/WsPYrBXXXOI/AAAAAAAAVyw/1cMGP21yZcU5Y9uEKNGHuu5LabzGdKGfwCLcBGAs/s1600/Bao-Lead-Image.jpg" alt="" />
        </Background>
        <ImageTitle>
        ...
        <SubTitle>
           2022 . 7m . Family, Fantasy, Kids, Anmation 
        </SubTitle>
        <Description>
